...
let image = ["img70.jpg","img71.jpg","img72.jpg","img73.jpg"]
...
function ChangeImg1(){
    ...
    displayImg.src = "/accidental-discussion-3173/images/img70.jpg"
}
function ChangeImg2(){
    let displayImg = document.querySelector(".imgss")
    let other = document.querySelector(".img1")
    displayImg.src = "/accidental-discussion-3173/images/img71.jpg"
}
function ChangeImg3(){
    let displayImg = document.querySelector(".imgss")
    let other = document.querySelector(".img2")
    displayImg.src = "/accidental-discussion-3173/images/img72.jpg"
}
function ChangeImg4(){
    let displayImg = document.querySelector(".imgss")
    let other = document.querySelector(".img3")
    displayImg.src = "/accidental-discussion-3173/images/img73.jpg"
}
...
AddtoCart.forEach((element,index)=>{
    let nm = document.querySelector("#ProductName").textContent
    if(element.Name == nm){
        A = false
    }
...
function Cartbtn1(){
    ...
    if(A == true){
        ...
        let Pn = document.querySelector("#ProductName").textContent
